...
import 'package:ecommerce/presentation/state_holders/AddToWishController.dart';
...
import 'package:ecommerce/presentation/ui/screen/home/product_dectails_slider.dart';
import 'package:ecommerce/presentation/ui/utility/app_colors.dart';
import 'package:ecommerce/presentation/ui/widget/custom_stepper.dart';
import 'package:ecommerce/presentation/ui/widget/sizePicker.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../../../data/models/productDetails.dart';
        ...
        children: [
          ...
          Row(
            children: [
              ...
              TextButton(
                onPressed: () {
                  Get.to(Review_screen(productId: productDetails.productId ?? 0,));
                },
                child: const Text(
                  'Review',
                  style: TextStyle(
                  ...
                  child: Center(
                    child: GetBuilder<AddToWishListController>(
                      ...
                      builder: (wishController) {
                        if(wishController.addToWishInProgress){
                          return const Center(child: CircularProgressIndicator(),);
                        }
                        return IconButton(
                          onPressed: ()async{
                            final result = await wishController.addToWish(
                                productDetails.productId ?? 0,);
                            if(result){
                              Get.snackbar('Added TO Wish List', 'This Product Added to Wish List',

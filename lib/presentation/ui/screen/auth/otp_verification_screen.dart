...
import '../../../state_holders/readProfileController.dart';
import 'complete_profiel_screen.dart';
  ...
  Future<void> verifyOtp(OtpVerificationController controller) async {
    ...
    await controller.verifyOtp(widget.email,_otpController.text.trim(), );
     if (response) {
       ...
       // final readProfileresponse = await readProfileController.verifyReadProfile();
       if(await Get.find<ReadProfileController>().verifyReadProfile() == true){

...
import 'package:ecommerce/data/models/wishData.dart';
...
class WishProductCard extends StatelessWidget {
  const WishProductCard({
    super.key, required this.wishData,
  });
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Get.to(ProductDetailsScreen(productId: wishData.product!.id!,));
      },
      child: Card(
